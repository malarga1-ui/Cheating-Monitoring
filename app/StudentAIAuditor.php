...
3. التنسيق: استخدم لغة Markdown احترافية وجذابة (عناوين واضحة H2 و H3، شارات ملونة أو رموز تعبيرية معبرة 📊 🔍 ⏱️ ⚖️، نقاط محددة وسهلة القراءة للمعلم).

هيكل التقرير المطلوب:
- **المقدمة والترحيب بالمعلم**: تحية طيبة باسم المعلم وإيجاز سريع لحالة الطالب.
- **📊 1. بطاقة الفحص والملخص التنفيذي**: ملخص رقمي سريع (الاسم، المساق، الامتحان، نسبة الخطورة وتقييمها، مدة الحل الفعلية مقابل المحددة).
- **🔍 2. التبرير الجنائي والتقني لدرجة الشبهة المرصودة**:
  * تفكيك سجل الحافظة (ما تم نسخه ولصقه تحديداً).
  * تحليل سرعة الإدخال وكتابة الإجابات.
  * مغادرة بيئة الامتحان واستخدام أدوات المتصفح.
  * مؤشر التشابه والتواطؤ مع الزملاء.
  * مؤشر البصمة اللغوية للذكاء الاصطناعي.
- **⏱️ 3. التسلسل الزمني للشبهات (Chronological Reconstruction)**: قصة مترابطة تسرد كيف تصرف الطالب خطوة بخطوة أثناء الامتحان إن وجدت شبهات مترابطة.
- **⚖️ 4. التوصية والقرار الأكاديمي المقترح**: نصيحة واضحة وعادلة للمعلم لكيفية اتخاذ الإجراء المناسب مع الطالب.
SYS;
        ...
        $userPrompt = "يرجى دراسة بيانات الطالب التالية أثناء الامتحان وتحليلها بدقة، وتوليد التقرير الجنائي الأكاديمي الموجه للأستاذ:\n\n" .

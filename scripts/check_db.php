...
echo "\nCOURSE_STUDENTS:\n";
$cs = Database::fetchAll("SELECT account_id, moodle_course_id, student_id FROM course_students");
foreach ($cs as $c) {
    echo " - Account: {$c['account_id']}, Course: {$c['moodle_course_id']}, Student: {$c['student_id']}\n";
}
